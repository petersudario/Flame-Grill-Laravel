                    ...
                    <div>
                        ...
                        <form class="text-white px-4 my-10 max-w-3xl mx-auto space-y-6">
                            <div class="grid 2xs:grid-cols-2 gap-4">
                                <div>
                                    <label class="text-xl" for="nome" style="text-shadow: 1px 1px 7px #151212">Nome completo *</label>
                                    <input class="border border-gray-400 py-2  px-4 w-full rounded focus:outline-none text-black" type="text" name="nome" required>
                                </div>
                                <div>
                                    <label class="text-xl" for="telefone" style="text-shadow: 1px 1px 7px #151212">Telefone *</label>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    <label class="text-xl" for="email" style="text-shadow: 1px 1px 7px #151212">E-mail *</label>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    <label class="text-xl" for="mensagem" style="text-shadow: 1px 1px 7px #151212">Escreva abaixo sua mensagem</label>
